...
pub fn print_stats(stats: &crate::simulation_event_handler::ComputedStats) {
    ...
    // Print unique state space size
    let unique_states = crate::game::get_global_unique_state_count();
    eprintln!("[STATE_SPACE] Total unique states across {} games: {}", stats.num_games, unique_states);
}
